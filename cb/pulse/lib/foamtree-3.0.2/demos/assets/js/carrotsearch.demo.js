  ...
  var introData = {
    groups: [
        ...
        groups: [
          ...
          },
          {
            ...
            holdAction: function() {
              ...
              changeInitializer(foamtree.get("initializer"));
            }
          }
        ],
        open: false
      ...
      { label: "JavaScript API, 35k gzipped", type: "inactive" },
      {
        ...
        type: "link",
        url: "http://carrotsearch.com/lingo3g",
