function streamingdataThree(data, dom_id) {
/*
var data = [
...
var tweetsBox = d3.select("#"+dom_id+"_tweet-stream-three");
var numberFormat = d3.format(',');

tweetsBox.selectAll('.tweetdiv').remove();

var tweet = tweetsBox.selectAll('.tweetdiv').data(data, function(d) {return d.id; });
...
.data(function(d) { return [d]; })
    ...
    .text(function(d) { return numberFormat(d.shares); })
    .insert("span")
    .text(" shares");
