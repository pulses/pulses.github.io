...
!function($) {
    ...
    Colorpicker.prototype = {
        ...
        show: function(e) {
            this.picker.show();
            this.height = this.component.size() > 0 ? this.component.outerHeight() : this.element.outerHeight();
            this.place();
        ...
        place: function() {
            var offset = this.component.size() > 0 ? this.component.offset() : this.element.offset();
            this.picker.css({
        ...
        mousemove: function(e) {
            ...
            this.element.trigger({
                type: 'changeColor',
                color: this.color,
                colorString: this.format.call(this)
            });
            return false;
        },
        mouseup: function(e) {
    ...
    $.fn.colorpicker = function(option, value) {
        if (option === "getValue") {
          return this.eq(0).data("colorpicker").getValue();
        }
