var mentionsWidget = (function() {    
  var _this = {
    showMentions: function(client_id, dom_id) {
      ...
      $.getScript("./lib/mentions/datacall_mentions.js", function(){
        mentions_datacall(clientid, dom_id);
      });
...
var mentions_dataSpec = {
  data: [ { analysis: "BandedMetricSeries", bucketTimeSpanMins:60 } ]
};

function mentions_handleUpdate(data, dom_id) {
