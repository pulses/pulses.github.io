...
data.forEach(function(d) {
            //d.date = parseDate(d.date); moment(String(d.datetime)).format('DD MMM') 
        ...
        .html(function(d) {
            ...
            for (var i in p) { 
                if (p[i].geoType == "STATE") { 
                    //return p[i].name + '<i class="fa fa-twitter"></i>' + d.date//moment(+d.datetime).fromNow();
                    //return p[i].name + ' ' + '&middot' + ' ' + d.date//moment(+d.datetime).fromNow();
                    return p[i].name
                }
            }  
            /*
            if(data.hasOwnProperty('location')){
                ...
                //return '<i class="fa fa-twitter"></i>' + d.date//moment(+d.datetime).fromNow();
                return d.date
            }
            */
        });
